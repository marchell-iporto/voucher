...
class ReceiveVoucherController extends Controller
{
    ...
    {
        $voucherType = $request->get('voucher_type', 'RV');
        ...
        return view('receive.index', compact('voucherNumber', 'voucherTypes', 'voucherType'));
    }
    ...
    {
        $voucherType = $request->get('type', 'RV');
